...
const Peohome: React.FC<PeohomeProps> = ({portrait,gender,classGrade,year,phone,isGraduate,username,name,team,mienImg,signature}) => {
    ...
    return (
        <div className="peo-home-container">
            ...
            <div className="basic-info-section">
                ...
                <div className="info-item">
                    <label>就职公司</label>
                    <span>暂未提供</span> {/* 这里接口数据未明确公司字段，可按需处理 */}
                </div>
                <div className="info-item">
                    <label>电 话</label>
                    <span>{phone}</span>
                ...
                <div className="info-item">
                    <label>个性签名</label>
                    <span>{signature}</span> {/* 接口数据未包含签名字段，可按需处理 */}
                </div>
                <div className="info-item">
                    <label>入学年</label>
                    <span>{year}</span>
