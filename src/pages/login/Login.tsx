        ...
        <div className="card2">
          <form className="form">
            ...
            <div className="field">
              ...
              <input type="text" className="input-field" placeholder="Password" value={password} onChange={(e)=>{setPassword(e.target.value)}}/>
            </div>
            <div className="field">
            <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="input-icon">
              ...
              <input type="text" className="input-field" placeholder="Vertify" value={captchaData} onChange={(e)=>{setCaptchaData(e.target.value)}}/>
              {captchaImg ? (
                <img 
                  src={captchaImg} 
                  alt="验证码" 
